...
class VerifyAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        code = self.request.data.get('code')  # 3633
    ...
    def check_verify(user, code):  # 12:03 -> 12:05 => expiration_time=12:05   12:04
        print(user, code)
        verifies = user.verify_codes.filter(code=code, is_confirmed=False)
        print(verifies)
...
class GetNewVerification(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        print("Tasdiqlash kodingiz qaytadan jo'natildi.", code)
        return Response(
            {
                "success": True,
...
class ChangeUserInformationView(UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        super(ChangeUserInformationView, self).update(request, *args, **kwargs)  # put
        data = {
            'success': True,
    ...
    def partial_update(self, request, *args, **kwargs):
        super(ChangeUserInformationView, self).partial_update(request, *args, **kwargs)  # patch
        data = {
            'success': True,
            "message": "User updated successfully",
            'auth_status': self.request.user.auth_status,
