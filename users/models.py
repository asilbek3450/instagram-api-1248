...
class User(AbstractUser, BaseModel):
    ...
    photo = models.ImageField(upload_to='user_photos/', null=True, blank=True, validators=[
...
# email -> asilbek@gmail.com -> clean_data (checks) -> save()
# phone -> +998 99 999 99 99 -> clean (checks) -> save()
